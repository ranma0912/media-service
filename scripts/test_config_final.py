...
def test_config_loading():
    ...
    try:
        ...
        tmdb_key = config.recognition.sources.tmdb.api_key
        logger.info(f"TMDB API Key: {'已配置' if tmdb_key else '未配置'}")
...
def test_naming_rules():
    ...
    try:
        # 加载命名规则配置
        naming_config = config_manager.load_naming_rules()

        # 测试电影命名规则
        logger.info("电影命名规则测试:")
        movie_template = naming_config['naming_rules']['movie']['default']
        ...
        # 测试电视剧命名规则
        logger.info("电视剧命名规则测试:")
        tv_template = naming_config['naming_rules']['tv']['default']
        ...
        # 测试动漫命名规则
        logger.info("动漫命名规则测试:")
        anime_template = naming_config['naming_rules']['anime']['default']
...
def main():
    ...
    if all_passed:
        logger.success("")
        logger.success("🎉 所有测试通过！配置系统工作正常。")
        logger.info("")
        logger.info("下一步：")
